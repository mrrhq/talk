...
import type { ProjectNode } from '../types/yakmap'
...
<template>
  <div ref="container" h-full w-full outline-none flex items-center class="yak-map" />
</template>

<style>
.yak-map .vis-network{
  zoom: calc(1/var(--slidev-slide-scale));
}
.yak-map div,
.yak-map button {
